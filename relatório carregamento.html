...
<body>
  <div class="container">
    <header>
      ...
      <p>Registro de carregamentos de açúcar VHP - Transportadoras pré-definidas</p>
    </header>
    ...
    <div class="system-container">
      <div class="card">
        ...
        <div class="form-container">
          ...
          <div class="input-group">
            <label for="check"><i class="fas fa-clipboard-check"></i> Checklist:</label>
            <i class="fas fa-tasks input-icon"></i>
            <input id="check" placeholder="Status do checklist" />
          </div>
      ...
      <div class="card">
        <div class="app-header" style="background: linear-gradient(90deg, #8b5cf6 0%, #7c3aed 100%);">
          ...
          <p>Como utilizar o sistema de registro</p>
        </div>
        
        <div class="form-container">
          <div class="input-group">
            <h3 style="margin-bottom: 20px; color: var(--primary);">Passo a Passo</h3>
            
            <div style="margin-bottom: 25px;">
              <h4><i class="fas fa-map-marker-alt" style="color: var(--silo-color);"></i> 1. Selecione o Local</h4>
              <p style="margin: 10px 0 15px 25px;">Escolha entre "Silo (Produção)" ou "Armazém" dependendo de onde o carregamento foi realizado.</p>
              
              <h4><i class="fas fa-building" style="color: var(--primary);"></i> 2. Selecione a Transportadora</h4>
              <p style="margin: 10px 0 15px 25px;">Escolha a transportadora responsável pelo carregamento na lista de opções.</p>
              
              <h4><i class="fas fa-edit" style="color: var(--warning);"></i> 3. Preencha os Dados</h4>
              <p style="margin: 10px 0 15px 25px;">Informe todos os dados solicitados: ordem de carregamento, motorista, placa, peso e checklist.</p>
              
              <h4><i class="fas fa-paper-plane" style="color: var(--success);"></i> 4. Envie os Dados</h4>
              <p style="margin: 10px 0 15px 25px;">Clique em "Enviar" para copiar a mensagem, "Copiar" para copiar a mensagem ou "WhatsApp" para compartilhar diretamente.</p>
            </div>
            
            <div style="background: rgba(37, 99, 235, 0.1); padding: 15px; border-radius: 10px; border-left: 4px solid var(--primary);">
              <h4><i class="fas fa-lightbulb" style="color: var(--warning);"></i> Dica Importante</h4>
              <p style="margin-top: 10px;">Após o envio, o sistema automaticamente copiará a mensagem e você pode compartilhar manualmente.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer>
      ...
      <p style="margin-top: 10px; font-size: 0.8rem; color: #64748b;">Transportadoras pré-definidas - COPERSUCAR S.A adicionada</p>
    </footer>
  </div>
  ...
  <script>
    ...
    // Estado da aplicação
    let carregamentoLocation = 'silo'; // Valor padrão
    ...
    function configurarEventos() {
      ...
      // Eventos de botões
      btnSend.addEventListener('click', enviarTudo);
    ...
    // Função para selecionar local de carregamento
    function selectLocation(location) {
      carregamentoLocation = location;
      ...
      showToast(`Local selecionado: ${location === 'silo' ? 'Silo' : 'Armazém'}`, "success");
    }
    ...
    function gerarMensagem() {
      ...
      const motorista = document.getElementById("mot